...
from libs.API_CAM.CameraParams_header import *
from libs.API_CAM.MvCameraControl_class import *
...
class CameraOperation:
    ...
    def Set_parameter(self, frameRate, exposureTime, gain): 
        ...
        if self.b_open_device:
            ...
            if ret != 0:
                print('show error', 'set acquistion frame rate fail! ret = ' + ToHexStr(ret))
                return ret
    ...
    def Work_thread(self, winHandle):
        ...
        while True:
            ...
            if 0 == ret:
                ...
                print("no data, ret = " + ToHexStr(ret))
                continue
